...
Partial Class UserControl_Funcionalidade_wucListarFuncionalidade
    Inherits System.Web.UI.UserControl
    Dim clsbuFuncionalidades As buSeguranca.buFuncionalidades
    ...
    Protected Sub PopulaDados(ByVal strWhere As String, ByVal blnShowState As Boolean, Optional ByVal strOrdem As String = "")
        ...
        Try
            ...
            dsCliente = clsbuFuncionalidades.Consultar(strWhere, strOrdem)
