...
Partial Class UserControl_Ranking_wucListarRanking
    Inherits System.Web.UI.UserControl
    Dim clsbuRankings As buCadastros.buRanking
    ...
    Protected Sub PopulaDados(ByVal strWhere As String, ByVal blnShowState As Boolean, Optional ByVal strOrdem As String = "")
        ...
        Try
            ...
            clsbuRankings = New buCadastros.buRanking()
            dsCliente = clsbuRankings.Consultar(strWhere, strOrdem)
    ...
    Protected Sub btnOk_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnOk.Click
        ...
        Try
            ...
            'dsDataAux.Tables.Add("Ranking")

            'dsDataAux.Tables("Ranking").Columns.Add("usCodigo", GetType(Integer))
            'dsDataAux.Tables("Ranking").Columns.Add("usNome", GetType(String))
            'dsDataAux.Tables("Ranking").Columns.Add("usLogin", GetType(String))

            'dsDataAux.Tables("Ranking").Rows.Add()
            'dsDataAux.Tables("Ranking").Rows.Add()
            'dsDataAux.Tables("Ranking").Rows.Add()

            'dsDataAux.Tables("Ranking").Rows(0)("usCodigo") = 1
            'dsDataAux.Tables("Ranking").Rows(0)("usNome") = "Nill"
            'dsDataAux.Tables("Ranking").Rows(0)("usLogin") = "nill.pinheiro"


            'dsDataAux.Tables("Ranking").Rows(1)("usCodigo") = 1
            'dsDataAux.Tables("Ranking").Rows(1)("usNome") = "Nill"
            'dsDataAux.Tables("Ranking").Rows(1)("usLogin") = "nill.pinheiro"

            'dsDataAux.Tables("Ranking").Rows(2)("usCodigo") = 1
            'dsDataAux.Tables("Ranking").Rows(2)("usNome") = "Nill"
            'dsDataAux.Tables("Ranking").Rows(2)("usLogin") = "nill.pinheiro"
