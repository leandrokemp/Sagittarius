...
Partial Class UserControl_ImprimirLista_wucImprimirLista
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            PopulaDados("ReqAtendido = 0", True)
    ...
    Protected Sub CheckBox1_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim chkAtendido As CheckBox = CType(sender, CheckBox)

        Dim drRowAux As GridViewRow = CType(chkAtendido.NamingContainer, GridViewRow)

        clsbuRequisicao.AlterarCheckBox(Convert.ToInt32(drRowAux.Cells(1).ToString()), chkAtendido.Checked)
