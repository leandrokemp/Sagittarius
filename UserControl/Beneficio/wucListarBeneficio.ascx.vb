...
Partial Class UserControl_Beneficio_WebUserControl
    ...
    Dim clsbuBeneficios As buCadastros.buBeneficio
    ...
    Protected Sub PopulaDados(ByVal strWhere As String, ByVal blnShowState As Boolean, Optional ByVal strOrdem As String = "")
        ...
        Try
            ...
            clsbuBeneficios = New buCadastros.buBeneficio()
            dsCliente = clsbuBeneficios.Consultar(strWhere, strOrdem)
        ...
        Try
            ...
            If cboEnumerdor.SelectedValue <> "todos" Then
                ...
                Select Case (cboOpcoes.SelectedValue)
                    Case "tipo_usuario"
                        strWhere.Append("ustipo_usuario ")
                    Case "ustipo_residuo"
                        strWhere.Append("ustipo_residuo ")
    ...
    Protected Sub btnOk_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnOk.Click
        ...
        Try
            ...
            'dsDataAux.Tables.Add("Beneficio")

            'dsDataAux.Tables("Beneficio").Columns.Add("usCodigo", GetType(Integer))
            'dsDataAux.Tables("Beneficio").Columns.Add("ustipo_usuario", GetType(String))
            'dsDataAux.Tables("Beneficio").Columns.Add("ustipo_residuo", GetType(String))

            'dsDataAux.Tables("Beneficio").Rows.Add()
            'dsDataAux.Tables("Beneficio").Rows.Add()
            'dsDataAux.Tables("Beneficio").Rows.Add()

            'dsDataAux.Tables("Beneficio").Rows(0)("usCodigo") = 1
            'dsDataAux.Tables("Beneficio").Rows(0)("ustipo_usuario") = "Nill"
            'dsDataAux.Tables("Beneficio").Rows(0)("ustipo_residuo") = "nill.pinheiro"


            'dsDataAux.Tables("Beneficio").Rows(1)("usCodigo") = 1
            'dsDataAux.Tables("Beneficio").Rows(1)("ustipo_usuario") = "Nill"
            'dsDataAux.Tables("Beneficio").Rows(1)("ustipo_residuo") = "nill.pinheiro"

            'dsDataAux.Tables("Beneficio").Rows(2)("usCodigo") = 1
            'dsDataAux.Tables("Beneficio").Rows(2)("ustipo_usuario") = "Nill"
            'dsDataAux.Tables("Beneficio").Rows(2)("ustipo_residuo") = "nill.pinheiro"
