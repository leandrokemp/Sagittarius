<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wucListarNoticias.ascx.vb" 
    Inherits="UserControl_Noticias_wucListarNoticias" %>
...
<asp:GridView ID="dgwDados" runat="server" AllowPaging="True" AutoGenerateColumns="False"
    ...
    <Columns>
        <asp:BoundField DataField="NotNome" HeaderText="Nome">
