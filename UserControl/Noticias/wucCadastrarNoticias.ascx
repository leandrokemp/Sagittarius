<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wucCadastrarNoticias.ascx.vb" 
    Inherits="UserControl_Noticias_wucCadastrarNoticias" %>
...
<fieldset style="vertical-align: middle; text-align: Center; width: 100%; border-style: inset;">
    <p style="text-align: center">
        <asp:Label ID="Label1" runat="server" Font-Size="Larger" ForeColor="Yellow" 
            style="text-align: center" Text="Notícias"></asp:Label>
    </p>
            ...
            <td style="vertical-align: middle; height: 2px; text-align: left">
                <table style="width: 260px">
                    <tbody>
                        <tr>
                            <td>
                                <asp:TextBox ID="txtNome" TabIndex="3" runat="server" Width="377px" CssClass="TextoControles"
            ...
            <td style="vertical-align: middle; height: 8px; text-align: left">
                <table style="width: 260px">
                    <tbody>
                        <tr>
                            <td>
                                <asp:TextBox ID="txtDescricao" TabIndex="5" runat="server" Width="649px" CssClass="TextoControles"
                                    MaxLength="1000" TextMode="MultiLine" Height="189px"></asp:TextBox>
            ...
            <td style="vertical-align: middle; height: 2px; text-align: left">
                <table style="width: 260px">
                    <tbody>
                        <tr>
                            <td>
                                <asp:TextBox ID="txtVideo" TabIndex="3" runat="server" Width="441px" CssClass="TextoControles"
                                    MaxLength="100"></asp:TextBox>
                            </td>
                        </tr>
                    </tbody>
            ...
            <td style="vertical-align: middle; height: 8px; text-align: left">
                <table style="width: 260px">
                    <tbody>
                        <tr>
                            <td>
                                <asp:TextBox ID="txtData" tooltip="date" TabIndex="5" runat="server" Width="130px" CssClass="TextoControles"
