<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wucListarpontosdecoleta.ascx.vb"
    Inherits="UserControl_PontosdeColeta_WebUserControl2" %>
<table>
    <tr>
        <td>
...
<asp:GridView ID="dgwDados" runat="server" AllowPaging="True" AutoGenerateColumns="False"
    DataKeyNames="pcCodigo" PageSize="20" EmptyDataText="Nenhum registro encontrado"
    Width="665px" CssClass="GridView">
    <Columns>
        <asp:BoundField DataField="pcLatitude" HeaderText="Latitude" />
        <asp:BoundField DataField="pcLongitude" HeaderText="Longitude" />
        <asp:BoundField DataField="pcDescricao" HeaderText="Descrição" />
