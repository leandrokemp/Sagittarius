...
Partial Class UserControl_ManterLeilão_wucListarLeilao
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            PopulaDados("l.usCodigo = " & clsUsuarioHelper.RetornaUsuarioLogado.Tables(0).Rows(0)("usCodigo").ToString(), True)
    ...
    Protected Sub dgwDados_PageIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgwDados.PageIndexChanged
        ...
        Try
            ...
            PopulaDados(Session("l.usCodigo = " & clsUsuarioHelper.RetornaUsuarioLogado.Tables(0).Rows(0)("usCodigo").ToString()), False)
        Catch ex As Exception
            Throw ex
        Finally
            strOrderBy = Nothing
    ...
    Private Function MontaFiltro() As String
        ...
        Try
            ...
            If cboEnumerdor.SelectedValue <> "todos" Then
                ...
                If cboOpcoes.SelectedValue <> "Data Inicio" Then
                ...
                If cboOpcoes.SelectedValue <> "Data Final" Then
