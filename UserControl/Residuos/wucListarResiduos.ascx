<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wucListarResiduos.ascx.vb"
    Inherits="UserControl_Residuos_WebUserControl" %>
<table>
    <tr>
        <td>
            <asp:DropDownList ID="cboOpcoes" runat="server" Width="110px">
                <asp:ListItem Value="ReNome">Nome</asp:ListItem>
                <asp:ListItem Value="RePontoKG">Nome</asp:ListItem>
            </asp:DropDownList>
        </td>
        <td>
...
<asp:GridView ID="dgwDados" runat="server" AllowPaging="True" AutoGenerateColumns="False"
    DataKeyNames="reCodigo" PageSize="20" Width="665px" CssClass="GridView">
    <Columns>
        <asp:BoundField DataField="ReNome" HeaderText="Nome">
            <HeaderStyle Width="305px" />
        </asp:BoundField>
        <asp:BoundField DataField="RePontoKG" HeaderText="Ponto KG">
            <HeaderStyle Width="305px" />
        </asp:BoundField>
        <asp:BoundField DataField="ReHabilitado" HeaderText="Habilitado" />
