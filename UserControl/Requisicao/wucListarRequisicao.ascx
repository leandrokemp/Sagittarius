...
<asp:Panel ID="pnlbtnNOvo" Style="text-align: left" runat="server">
    <asp:ImageButton ID="btnNovo" Visible="false" runat="server" ImageUrl="~/Imagem/novo.png" />
</asp:Panel>
<br />
        ...
        <asp:TemplateField HeaderText="Atendido">
            <ItemTemplate>
                ...
                <asp:CheckBox ID="chkAlterar" Checked='<%#  Convert.ToBoolean(Eval("ReqAtendido")) %>'
                    Enabled="true" ToolTip="Marcar como Atendido" AutoPostBack="true" runat="server"
