<%@ Control Language="VB" AutoEventWireup="false" CodeFile="wucListarTipoFuncionalidade.ascx.vb"
    Inherits="UserControl_TipoFuncionalidade_wucListarTipoFuncionalidade" %>
<table>
    <tr>
        <td>
